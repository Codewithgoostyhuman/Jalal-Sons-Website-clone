...
const LogoBar = () => {
  return (
    <div className='bg-black w-dvw h-fit flex items-center justify-center border-b-4 border-red-200'>
        <div className='h-fit w-full sm:w-full md:w-fit lg:w-fit xl:w-fit flex flex-col-reverse sm:flex-col-reverse md:flex-row lg:flex-row xl:flex-row items-center justify-between p-2 text-white'>
            <div className=' h-fit w-fit items-center flex flex-row md:flex-row gap-4 m-4 p-2'>
                ...
                <div className='w-50'>location selection menu</div>
            </div>
            <img src=Jalal-Sons-Website-clone/src/assets/jalasons logo.webp" alt="Jalalson Logo" className='h-12 sm:h-14 md:h-16 lg:h-18 xl:h-20 xl:w-130 lg:w-90 md:w-50 sm:w-30 object-contain m-4 transition-all duration-1000 ease-in-out'/>
