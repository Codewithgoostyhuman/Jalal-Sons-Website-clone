...
const LogoBar = () => {
  return (
    <div className='bg-black w-dvw h-fit flex items-center justify-center border-b-4 border-red-200 text-[10px] sm:text-[12px] md:text-[14px] lg:text-[16px] xl:text-[18px]'>
